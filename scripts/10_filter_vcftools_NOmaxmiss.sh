...
input_vcf=./07_FINAL_populations_out/populations.snps.vcf
fileprefix=URO_all
...
singularity exec $VCFTOOLSIMG vcftools --vcf $input_vcf --min-meanDP 2 --max-meanDP 1000 --recode --mac 2 --out ./09_vcftools_out/${fileprefix}
